...
export const AuthProvider = ({ children }) => {
  ...
  // This useEffect is crucial for initializing user state from localStorage
  useEffect(() => {
    ...
    if (savedUser) {
      try {
        ...
        // Using setTimeout to ensure navigation happens after initial render
        setTimeout(() => {
    ...
    // Set loading to false after the check (this is crucial)
    console.log("AuthProvider: Setting loading to false. Final user state:", user); // Debug log
    setLoading(false);
  }, [navigate]); // Add navigate to dependency array - This is key!
